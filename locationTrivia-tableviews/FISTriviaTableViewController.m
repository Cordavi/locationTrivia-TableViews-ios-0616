...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    NSArray *trivia = self.triviaFromLocation.trivia;
    return [trivia count];
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TriviaInLocation" forIndexPath:indexPath];
    
    FISTrivium *currentTrivia = self.triviaFromLocation.trivia[indexPath.row];
